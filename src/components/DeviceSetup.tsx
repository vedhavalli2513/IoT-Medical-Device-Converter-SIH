  ...
  const handleComplete = () => {
    const newDevice = {
      ...
      vitals: {
        ...
        bloodGlucose: Math.floor(Math.random() * 30) + 80,
        painLevel: Math.floor(Math.random() * 5) + 1,
        consciousnessLevel: Math.floor(Math.random() * 3) + 13,
        ...
        ecgRhythm: ['normal', 'arrhythmia', 'tachycardia', 'bradycardia'][Math.floor(Math.random() * 4)] as any
      },
